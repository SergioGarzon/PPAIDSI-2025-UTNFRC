...
class PantallaRegistrarRevisionManual:
    ...
    def habilitar_pantalla(self): 
        ...
        self.mostrar_eventos_sismicos()     
        self.new_window.mainloop()       

    # METODO 16 (Diagrama de secuencia) 
    def mostrar_eventos_sismicos(self):
        
        for i, evento in enumerate(self.gestor.obtener_eventos_para_mostrar()):
    ...
    def mostrar_datos(self):
        ...
        self.text_box_alcance.insert("1.0", self.datos_mostrar[1])
        ...
        self.text_box_origen_generacion.insert("1.0", self.datos_mostrar[0])
